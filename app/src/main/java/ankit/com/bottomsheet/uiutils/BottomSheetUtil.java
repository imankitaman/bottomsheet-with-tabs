...
public class BottomSheetUtil {
    ...
    private static class BottomSheetViewPagerListener extends ViewPager.SimpleOnPageChangeListener {
        ...
        private final MyBottomSheetBehavior<View> behavior;

        public BottomSheetViewPagerListener(ViewPager viewPager, View bottomSheetParent) {
            this.viewPager = viewPager;
            this.behavior = MyBottomSheetBehavior.from(bottomSheetParent);
        }
    ...
    private static View findBottomSheetParent(final View view) {
        ...
        while (current != null) {
            ...
            if (params instanceof CoordinatorLayout.LayoutParams && ((CoordinatorLayout.LayoutParams) params).getBehavior() instanceof MyBottomSheetBehavior) {
                return current;
            }
